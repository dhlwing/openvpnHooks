...
class ClassLoader
{
    ...
    public static function load($class)
    {
        ...
        foreach (static::$directories as $directory) {
            ...
            if (file_exists($path = $directory.DIRECTORY_SEPARATOR.$class.'.php')) {
                ...
                return true;
            } elseif (file_exists($path = $directory.DIRECTORY_SEPARATOR.strtolower($class).'.php')) {
                require_once $path;

                return true;
            } elseif (file_exists($path = $directory.DIRECTORY_SEPARATOR.strtolower($class).'.class.php')) {
                require_once $path;

                return true;
            } elseif (file_exists($path = $directory.DIRECTORY_SEPARATOR.$class.'.class.php')) {
                require_once $path;
    ...
    public static function register()
    {
        if (! static::$registered) {
            static::$registered = spl_autoload_register(array('shell\ClassLoader', 'load'));
        }
    }
