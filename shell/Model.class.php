...
class Model {
    ...
    public static function getInstance($table = 0) {
        static $_instance   =   array();
        if(!isset($_instance[$table])){
            $obj    =   new static();
            $_instance[$table]   =   $obj;
        }
    ...
    protected function parseSql($sql,$parse) {
        ...
        if(true === $parse) {
            ...
            //$sql    =   preg_replace_callback("/__([A-Z_-]+)__/sU", function($match) { return $prefix.strtolower($match[1]);}, $sql);

            $sql    =   preg_replace_callback("/__([A-Z_-]+)__/sU", array($this,'sqlReplace'), $sql);
    ...
    protected function sqlReplace($match) {
        $prefix =   $this->tablePrefix;
    ...
    public function table($table) {
        ...
        if(is_array($table)) {
            ...
            $table  = preg_replace_callback("/__([A-Z_-]+)__/sU", array($this,'sqlReplace'), $table);
            $this->options['table'] =   $table;
        }
        return $this;
    }
    ...
    public function join($join,$type='INNER') {
        ...
        if(is_array($join)) {
            foreach ($join as $key=>&$_join){
                ...
                $_join  =   preg_replace_callback("/__([A-Z_-]+)__/sU", array($this,'sqlReplace'), $_join);
            ...
            $join  = preg_replace_callback("/__([A-Z_-]+)__/sU", array($this,'sqlReplace'), $join);
    ...
    public function union($union,$all=false) {
        ...
        if(is_string($union) ) {
            ...
            $options  = preg_replace_callback("/__([A-Z_-]+)__/sU", array($this,'sqlReplace'), $union);
